...
\url{https://albertoHdzE.github.io/website/} $\bullet$ \url{https://linkedin.com/in/alberto-hernandeze} $\bullet$ \url{github.com/albertoHdzE}
\end{center}
...
\item knowy: Agentic Epistemic Architecture
\begin{itemize}
\item 8-layer agentic system for personal knowledge compilation, enforcing strict boundaries between operational and epistemic agents to ensure integrity.
\item Orchestrates multimodal processing (video/text/code) using LangGraph, local LLMs (Ollama/LLaMA 3.2 Vision), and automated diagram generation.
\item Code: \url{https://github.com/albertoHdzE/knowy}
\end{itemize}
